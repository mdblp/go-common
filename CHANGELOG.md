...
## 2.2.0 - 2025-09-19
### Changed
- Move package version from client to the root of  the repo (and mark the old one as deprecated)
...
## 2.0.0 - 2023-05-23
### Changed
- New error with stack trace printing
...
- Add a new error type "StackError" which tracks details about the error source.

## 1.7.1 - 2023-02-21
### Engineering
- New error wrapper utility
